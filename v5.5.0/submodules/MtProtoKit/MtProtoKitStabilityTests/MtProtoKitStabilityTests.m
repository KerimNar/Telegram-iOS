...
- (void)testExample {
    ...
    //for (int i = 0; i < 100; i++) {
        ...
        _transport = [[MTTcpTransport alloc] initWithDelegate:self context:context datacenterId:1 address:[[MTDatacenterAddress alloc] initWithIp:@"47.103.102.219" port:12443 preferForMedia:false]];
